#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe -W setup.py win_service.py
...
win_service = Target(
    ...
    script="win_service.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'win_service'
    # dest_base = "win_service",

    # Icon resources:[(resource_id, path to .ico file), ...]
    # icon_resources=[(1, r"win_service.ico")]

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="win_service", level="asInvoker")).encode("utf-8")),
